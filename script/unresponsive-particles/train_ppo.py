...
sde_sample_freq = -1
target_kl = None
tensorboard_log = "ppo_unresponsive_particles_log"
...
for idx in range(3):
  ...
  model.save("ppo_dpr_unresponsive_particles_single_{}".format(idx))

# SAVE AND LOAD
# model.save("ppo_dpr_unresponsive_particles_single")
# del model
# model = PPO.load("ppo_dpr_unresponsive_particles_single")
#
