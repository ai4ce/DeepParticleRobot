...
max_grad_norm=10
tensorboard_log="dqn_unresponsive_particles_log"
...
for idx in range(3):
  ...
  model.save("deepq_dpr_unresponsive_particles_single_{}".format(idx))

# SAVE AND LOAD
# model.save("deepq_dpr_unresponsive_particles_single")
# del model
# model = DQN.load("deepq_dpr_unresponsive_particles_single")
#
