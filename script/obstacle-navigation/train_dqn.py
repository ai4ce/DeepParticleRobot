...
max_grad_norm=10
tensorboard_log = "dqn_obstacle_navigation_log"
...
for idx in range(3):
  ...
  model.save("deepq_dpr_obstacle_navigation_single_{}".format(idx))

# SAVE AND LOAD
# model.save("deepq_dpr_obstacle_navigation_single")
# del model
# model = DQN.load("deepq_dpr_obstacle_navigation_single")
#
