...
tensorboard_log = "a2c_object_manipulation_log"
...
for idx in range(3):
  ...
  model.save("a2c_dpr_object_manipulation_single_{}".format(idx))

# SAVE AND LOAD
# model.save("a2c_dpr_object_manipulation_single")
# del model
# model = A2C.load("a2c_dpr_object_manipulation_single")
#
