...
learning_rate = 0.00075 # using linear schedule
n_steps = 200
gamma = 1.0
gae_lambda = 0.99
ent_coef = 0.0
...
tensorboard_log = "a2c_simple_navigation_log"
...
for idx in range(3):
  ...
  model = A2C("MlpPolicy",
              env,
              learning_rate = linear_schedule(0.0075),
              n_steps = n_steps,
              gamma = gamma,
  ...
  model.save("a2c_dpr_simple_navigation_single_{}".format(idx))

# SAVE AND LOAD
# model.save("a2c_dpr_simple_navigation_single")
# del model
# model = A2C.load("a2c_dpr_simple_navigation_single")
#
