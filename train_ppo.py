...
learning_rate = 0.0001 # using linear schedule
n_steps = 40000
batch_size = 16
n_epochs = 10
gamma = 1.0
...
sde_sample_freq = -1
target_kl = None
tensorboard_log = "ppo_simple_navigation_log"
...
for idx in range(3):
  ...
  model.save("ppo_dpr_simple_navigation_single_{}".format(idx))

# SAVE AND LOAD
# model.save("ppo_dpr_simple_navigation_single")
# del model
# model = PPO.load("ppo_dpr_simple_navigation_single")
#
